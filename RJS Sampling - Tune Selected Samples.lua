...
--
-- To change mode (pitch/playrate) use a project marker as an input command:     'tune [mode]'       [mode] = pitch OR rate
-- To change the default mode, change the code line below.
--
-- author: Risto Sipola
